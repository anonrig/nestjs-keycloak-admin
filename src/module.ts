...
import { KeycloakAdminOptions, KeycloakAdminModuleAsyncOptions } from './@types/package'
...
export class KeycloakAdminModule {
  ...
  public static registerAsync(options: KeycloakAdminModuleAsyncOptions): DynamicModule {
  ...
  private static getCustomOptions(options: KeycloakAdminModuleAsyncOptions): Provider {
    return {
